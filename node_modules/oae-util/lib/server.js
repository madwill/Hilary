...
var setupServer = module.exports.setupServer = function(port, _config) {
    ...
    addSafePathPrefix("/api/content/create");
    ...
    app.use(function(req, res, next) {
        ...
        if (!_isSafeMethod(req.method) && !_isSafePath(req) && !_isSameOrigin(req)) {
            log().warn({
                ...
                'targetPath': req.path,
                '_isSafeMethod':_isSafeMethod(req.method),
                '_isSafePath(req)': _isSafePath(req),
                '_isSameOrigin': _isSameOrigin(req)
